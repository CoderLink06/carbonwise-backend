...
import { Leaf, Mail, Lock, Eye, EyeOff, Loader } from "lucide-react";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-eco-mint/20 to-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        {/* Header */}
        <div className="text-center space-y-4">
          <Link to="/" className="inline-flex items-center space-x-2">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-eco">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Sign in to your carbon tracking account
            </p>
          </div>
        </div>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                size="lg"
                disabled={isLoading}
                className="w-full bg-gradient-eco hover:bg-gradient-eco/90 text-white"
              >
                {isLoading ? (
                  <>
